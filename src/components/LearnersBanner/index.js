		...
		<div className="bg-cyno-yellow ">
			...
			<div className="flex flex-col items-center justify-center w-full h-full">
				<div className="flex flex-row flex-wrap items-center justify-center w-4/5 mt-12 mb-2 gap-7">
					{learnerImages.map((image, i) => (
						<div
							key={i}
							className="flex w-[100px] h-[100px] rounded-[50%] border-2 border-white items-center justify-center overflow-hidden">
							<img
								src={image}
								alt="learner"
				...
				<div className="flex flex-wrap items-center justify-center w-4/5 max-sm:gap-8 gap-14 my-14 ">
					{learnerCompanies.map((image, i) => (
						<div
							key={i}
							className="w-1/5 h-12 max-sm:w-2/5">
							<img
								src={image}
								alt="company"
